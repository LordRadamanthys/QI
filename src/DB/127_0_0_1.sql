...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Fev-2019 às 03:45
...
--
-- Estrutura da tabela `mensagens_sindico_adm`
--

CREATE TABLE `mensagens_sindico_adm` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura da tabela `mensagens_solicitante_adm`
--

CREATE TABLE `mensagens_solicitante_adm` (
  `id` int(11) NOT NULL,
  `tipo_usuario` varchar(255) NOT NULL,
  `mensagem` text NOT NULL,
  `id_usuario` int(11) NOT NULL,
...
--
-- Indexes for table `mensagens_sindico_adm`
--
ALTER TABLE `mensagens_sindico_adm`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mensagens_solicitante_adm`
--
ALTER TABLE `mensagens_solicitante_adm`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mensagens_sindico_adm`
--
ALTER TABLE `mensagens_sindico_adm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mensagens_solicitante_adm`
--
ALTER TABLE `mensagens_solicitante_adm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
