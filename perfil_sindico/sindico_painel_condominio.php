			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="fas fa-building"></i> Condomínios</h2>
					</div>
					<div class="linha-conteudo">
						<div class="vagas-opcao principal">
							<div class="vagas-opcao-cont" style="background-color: #fff">
								...
								<div class="quadros-titulo"><span class="titulo-perfil"><h2>Condomínios</h2></span></div>
								<div class="quadros">
                    	...
                    	?>
									<div class="quadro" >
										<a href="sindico_info_condominio.php?h=<?=  $condominios['id'] ?>">
											<div class="quadro-img" style="background-image: url(../src/usuarios_cond/<?= $condominios['id']?>/foto/perfil.jpg);"></div>
											<div class="quadro-txt"><div><?= $condominios['nome_cond'] ?></div></div>
										</a>
									</div>
                    ...
                    ?>
									<a href="sindico_info_vaga.php?h=<?= $vagas['id_condominio'] ?>&v=<?= $vagas['id'] ?>">
										...
										<div class="table-txt"><div><?= $vagas['posicao'] ?><hr><?= $nome_cond['nome_cond'] ?></div></div>
									</a>
