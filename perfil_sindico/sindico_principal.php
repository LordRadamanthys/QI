			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="far fa-user"></i> Principal</h2>
					</div>
						...
						<div class="vaga principal">
							<div class="vagas-opcao-cont" style="background-color: #fff">
								<div class="texto texto-infos-vagas">
									<div class="quadros-titulo"><span class="titulo-perfil"><h2>Bem Vindo</h2></span></div>
									<div class="quadros">
										<div class="quadro" >
											<a href="sindico_perfil.php">
												<div class="quadro-img"><i class="far fa-user"></i></div>
												<div class="quadro-txt"><div>Perfil</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="sindico_painel_vagas.php">
												<div class="quadro-img"><i class="fas fa-clipboard"></i></div>
												<div class="quadro-txt"><div>Vagas</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="sindico_painel_seguindo.php">
												<div class="quadro-img"><i class="far fa-building"></i></div>
												<div class="quadro-txt"><div>Seguindo</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="sindico_painel_condominio.php">
												<div class="quadro-img"><i class="fas fa-building"></i></div>
												<div class="quadro-txt"><div>Condomínios</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="sindico_candidaturas.php">
												<div class="quadro-img"><i class="far fa-folder"></i></div>
												<div class="quadro-txt"><div>Minhas Candidaturas</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="sindico_mensagem.php">
												<div class="quadro-img"><i class="far fa-envelope"></i></div>
												<div class="quadro-txt"><div>Mensagens</div></div>
											</a>
										</div>
									</div>
								</div>
