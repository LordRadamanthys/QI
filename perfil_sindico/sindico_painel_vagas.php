			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="fas fa-clipboard"></i> Painel de vagas</h2>
					</div>
					<div class="linha-conteudo">
						<div class="vagas-opcao principal">
							<div class="vagas-opcao-cont" style="background-color: #fff">
								...
								<div class="quadros-titulo"><span class="titulo-perfil"><h2>Vagas disponíveis</h2></span></div>
								<div class="quadros">
						<?php
						$result = $con->result;  
						if($vagas > 0){   
                    ...
                    ?>
									<div class="quadro">
										<a href="sindico_info_vaga.php?h=<?= $vagas['id_condominio'] ?>&v=<?= $vagas['id'] ?>">
											...
											<div class="quadro-txt"><div><p><?= $vagas['posicao'] ?><hr><?= $nome_cond['nome_cond'] ?></div></div>
										</a>
									</div>
