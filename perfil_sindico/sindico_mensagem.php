...
$mensagens = $con->pegarMensagemSindico($_SESSION['UsuarioID']);
												...
												<div oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
													...
													<div class="mensagem-cont animated fade-in-dow" style="display: block;">
														<div class="email-conteudo">
															<div class="e-mails">
						<?php
						$result = $con->sind_mensagem;  
						if($mensagens > 0){   
                             do{
                             	if($mensagens['tipo_usuario']=="sindico"){
                    	?>
						...
						<?php }	
							...
							?>
															...
															<div class="e-mail-mesnagem">
																<form method="post" action="../paginasPHP/sindico_mensagem.php"c style="display: inline-block; text-align: center; margin-top: -2px;" >
														<input type="hidden" name="id_usuario" value="<?=$_SESSION['UsuarioID']?>">
														<input type="hidden" name="tipo_usuario" value="sindico">
