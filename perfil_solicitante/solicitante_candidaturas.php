			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="far fa-folder"></i> Candidaturas</h2>
					</div>
						...
						<div class="vaga">
							<div class="texto texto-infos-vagas">
								<div class="vagas-opcao-cont" style="background-color: #fff">
									...
									<div class="quadros-titulo"><span class="titulo-perfil"><h2>Candidatos para minhas vagas</h2></span></div>
									<div class="quadros">
										<?php
						 					$con->listarMeusCandidatos($_SESSION['UsuarioID']);
										?>
									</div>
								</div>
							</div>
