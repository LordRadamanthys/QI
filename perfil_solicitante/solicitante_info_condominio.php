...
$id= $_GET['h'];
$dados_condominio = $con->listarCondominiosPerfil($id);
			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="fas fa-building"></i> Perfil do Condomínio</h2>
					</div>
							...
							<div class="vagas-opcao-cont">
								<div class="texto texto-infos-vagas">
									<div class="banner-perfil">
										<a href="solicitante_editar_condominio.html" title="Editar condomínio"><i class="fas fa-user-edit"></i></a>
										<i class="fas fa-times-circle" title="Excluir condomínio" onclick="document.getElementById('excluir').style.display='flex'"></i>
										<div class="linha">
											<div class="img-perfil-conteudo" style="background-image: url(../src/usuarios_cond/<?=$dados_condominio['id']?>/foto/perfil.jpg);"></div>
											<div class="nome-perfil">
												<h2><?= $dados_condominio['nome_cond'] ?></h2>
												<hr>
												<h3><?= $dados_condominio['tipo_cond'] ?></h3>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="linha-conteudo" style="width: 96%; padding: 5px 2%">
											<div class="quadro-sobre">
												<div class="titulo-quadro">
													...
													<a href="solicitante_editar_condominio.html" title="Editar condomínio">
														<i class="fas fa-user-edit"></i>
													</a>
												</div>
												<div class="text-quadro animated fade-in-down">
													<span class="info-titulo">Nome do condomínio:</span> <?= $dados_condominio['nome_cond'] ?><br>
													<span class="info-titulo">Tipo:</span> <?= $dados_condominio['tipo_cond'] ?><br>
													<span class="info-titulo">Quantidade de unidades:</span> <?= $dados_condominio['unidades_cond'] ?><br>
													<span class="info-titulo">Idade do empreendimento:</span> <?= $dados_condominio['idade_cond'] ?><br>	
												</div>
											</div>
											<div class="quadro-sobre">
												<div class="titulo-quadro">
												...
												<div class="text-quadro animated fade-in-down">
													<span class="info-titulo">CEP:</span> <?= $dados_condominio['cep_cond'] ?><br>
													<span class="info-titulo">País:</span> <?= $dados_condominio['pais_cond'] ?><br>
													<span class="info-titulo">Estado:</span> <?= $dados_condominio['estado_cond'] ?><br>
													<span class="info-titulo">Cidade:</span> <?= $dados_condominio['cidade_cond'] ?><br>	
													<span class="info-titulo">Endereço:</span> <?= $dados_condominio['endereco_cond'] ?><br>	
													<span class="info-titulo">Complemento:</span> <?= $dados_condominio['complemento_cond'] ?><br>
													<span class="info-titulo">Número:</span>  <?= $dados_condominio['numero_cond'] ?><br>		
												</div>
											</div>
										</div>
									</div>
