						...
						<div class="vaga principal">
							<div class="texto texto-infos-vagas">
								<div class="vagas-opcao-cont" style="background-color: #fff">
									...
									<div class="quadros">
										<div class="quadro" >
											<a href="solicitante_perfil.php">
												<div class="quadro-img"><i class="far fa-user"></i></div>
												<div class="quadro-txt"><div>Perfil</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="solicitante_painel_vagas.php">
												<div class="quadro-img"><i class="fas fa-clipboard"></i></div>
												<div class="quadro-txt"><div>Minhas Vagas</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="solicitante_painel_condominio.php">
												<div class="quadro-img"><i class="fas fa-building"></i></div>
												<div class="quadro-txt"><div>Meus Condomínios</div></div>
											</a>
										</div>
										<div class="quadro">
											<a href="solicitante_candidaturas.php">
												<div class="quadro-img"><i class="far fa-folder"></i></div>
												<div class="quadro-txt"><div>Candidaturas</div></div>
											</a>
										</div>
										<div class="quadro" >
											<a href="solicitante_mensagem.php">
