			...
			<div class="cont-conteudo">
				<div class="c1">
					<div class="caminho">
						...
						<h2 class="caminho-ativo"><i class="fas fa-building"></i> Meus Condomínios</h2>
					</div>
					...
					<div class="linha-conteudo">
						<div class="vaga">
							<div class="texto texto-infos-vagas">
								<div class="vagas-opcao-cont" style="background-color: #fff">
									...
									<div class="quadros-titulo"><span class="titulo-perfil"><h2>Meus Condomínios</h2></span></div>
									<div class="quadros">
										<div class="quadro" >
											<a href="solicitante_condominio_form.php">
												<div class="quadro-img"><i class="fas fa-plus-circle"></i></div>
												<div class="quadro-txt" style="align-items: center; padding-bottom: 0px; height: 130px;"><div>Adicionar<hr>condomínio</div></div>
											</a>
										</div>
						<?php
						$result = $con->result; 
						...
						<?php }while ($condominio = mysqli_fetch_assoc($result));
						}else{
							echo "";
						} ?>
									</div>
