...
$usu=$con->listarDadosSind($_GET['h']);
									...
									<div class="banner-perfil">
										<div class="linha">
											...
											<div class="nome-perfil">
												...
												<hr>
												<h3><?= $dados_usuario_esco['nome_curso'] ?></h3>
											</div>
										</div>
									</div>
											...
											<div class="texto">
												<div class="linha-conteudo">
													...
													<div class="quadro-sobre">
														...
														<div class="text-quadro">
															<span class="info-titulo">Perfil público:</span> <?= $dados_usuario['hash'] ?><br>
															...
															<span class="info-titulo">E-mail:</span> <?=$dados_usuario['email']?><br>										
														</div>
													</div>
